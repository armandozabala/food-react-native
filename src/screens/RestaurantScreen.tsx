...
import { View, StyleSheet, SafeAreaView, Text, Image, TouchableOpacity, Animated } from 'react-native';
...
const RestaurantScreen = ({route}:any) => {
    ...
    const  [restaurant, setRestaurant ] = useState<any>(item);
    ...
    const editOrder = (action:any, menuId:any, price:any) => {
    ...
    const sumOrder = () => {
        ...
        let total = orderItems.reduce((a:any,b:any) => a+(b.total || 0),0);
